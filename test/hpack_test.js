    ...
    context('Response examples compression', function(){
      ...
      it('should encode first header', function(){
        ...
        var encoded_headers = new Buffer([
          ...
          0x31, 0x20, 0x47, 0x4d, 0x54, 0x0f, 0x22, 0x17,
        ...
        expect(ctx._header_table.size).to.eql(159);
      });
      ...
      it('should encode second header', function(){
        ...
        var encoded_headers = new Buffer([
          0x8b, 0x0f, 0x23, 0x17, 0x68, 0x74, 0x74, 0x70,
        ...
        expect(buffer).to.eql(encoded_headers);
        expect(ctx._header_table.length).to.eql(4);
        expect(ctx._header_table.size).to.eql(201);
      });
      ...
      it('should encode third header', function(){
        ...
        var encoded_headers = new Buffer([
          0x42, 0x1d, 0x4d, 0x6f, 0x6e, 0x2c, 0x20, 0x32,
          0x31, 0x20, 0x4f, 0x63, 0x74, 0x20, 0x32, 0x30,
          0x31, 0x33, 0x20, 0x32, 0x30, 0x3a, 0x31, 0x33,
          0x3a, 0x32, 0x32, 0x20, 0x47, 0x4d, 0x54, 0x0f,
          0x23, 0x17, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3a,
          0x2f, 0x2f, 0x77, 0x77, 0x77, 0x2e, 0x65, 0x78,
          0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x63, 0x6f,
          0x6d, 0x84, 0x84, 0x5e, 0x04, 0x67, 0x7a, 0x69,
          0x70, 0x0f, 0x2c, 0x38, 0x66, 0x6f, 0x6f, 0x3d,
          ...
          0x6f, 0x6e, 0x3d, 0x31, 0x84
        ]);

        var buffer = ctx.compress(headers);
        expect(buffer).to.eql(encoded_headers);
        expect(ctx._header_table.length).to.eql(4);
        expect(ctx._header_table.size).to.eql(224);
      });
    });
    ...
    context('Response examples with Huffman compression', function(){
      ...
      it('should encode first header', function(){
        ...
        var encoded_headers = new Buffer([
          ...
          0x0f, 0x22, 0x91, 0xad, 0xce, 0xbf, 0x19, 0x8e,
          0x7e, 0x7c, 0xf9, 0xbe, 0xbe, 0x89, 0xb6, 0xfb,
          0x16, 0xfa, 0x9b, 0x6f
        ]);
      ...
      it('should encode second header', function(){
        ...
        var encoded_headers = new Buffer([
          0x8b, 0x0f, 0x23, 0x91, 0xad, 0xce, 0xbf, 0x19,
          0x8e, 0x7e, 0x7c, 0xf9, 0xbe, 0xbe, 0x89, 0xb6,
          0xfb, 0x16, 0xfa, 0x9b, 0x6f, 0x84
        ]);
      ...
      it('should encode third header', function(){
        ...
        var encoded_headers = new Buffer([
          0x42, 0x93, 0xd6, 0xdb, 0xb2, 0x98, 0x84, 0xde,
          0x2a, 0x71, 0x88, 0x05, 0x06, 0x20, 0x98, 0x51,
          0x31, 0x11, 0xb5, 0x6b, 0xa3, 0x0f, 0x23, 0x91,
          0xad, 0xce, 0xbf, 0x19, 0x8e, 0x7e, 0x7c, 0xf9,
          0xbe, 0xbe, 0x89, 0xb6, 0xfb, 0x16, 0xfa, 0x9b,
          0x6f, 0x84, 0x84, 0x5e, 0x84, 0xab, 0xdd, 0x97,
          0xff, 0x0f, 0x2c, 0xb1, 0xe0, 0xd6, 0xcf, 0x9f,
          0x6e, 0x8f, 0x9f, 0xd3, 0xe5, 0xf6, 0xfa, 0x76,
          0xfe, 0xfd, 0x3c, 0x7e, 0xdf, 0x9e, 0xff, 0x1f,
          0x2f, 0x0f, 0x3c, 0xfe, 0x9f, 0x6f, 0xcf, 0x7f,
          0x8f, 0x87, 0x9f, 0x61, 0xad, 0x4f, 0x4c, 0xc9,
          0xa9, 0x73, 0xa2, 0x20, 0x0e, 0xc3, 0x72, 0x5e,
          0x18, 0xb1, 0xb7, 0x4e, 0x3f, 0x84
        ]);
